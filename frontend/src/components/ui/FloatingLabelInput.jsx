  ...
  return (
    <div className={`relative w-full group ${className}`}>
      <input
        ...
        className={`
          peer w-full px-4 pt-5 pb-2 text-sm ${isDark ? "text-slate-50 bg-slate-800" : "text-slate-800 bg-slate-50"} rounded-xl border outline-none
          transition-all duration-200
          ${readOnly ? `cursor-default ${isDark ? "text-slate-50" : "text-slate-800"}` : ""}
          ${
            isFocused
              ? `ring-4 ${isDark ? "border-slate-700 ring-slate-700" : "border-slate-100 ring-slate-100"} shadow-sm`
