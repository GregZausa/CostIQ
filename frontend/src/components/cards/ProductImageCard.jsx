...
const ProductImageCard = ({ src, alt = "Product", name, description }) => {
  return (
    <div className="group relative bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden hover:shadow-md hover:border-gray-200 transition-all duration-300">
      <div className="relative h-105 overflow-hidden bg-slate-50 flex items-center justify-center">
        <img
          src={src}
          alt={alt}
        ...
        <div className="absolute inset-0 bg-gray-500/0 group-hover:bg-gray-500/10 transition-colors duration-300" />
      </div>
      {(name || description) && (
